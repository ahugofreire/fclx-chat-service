...
func NewChatService(chatCompletionStreamUseCase chatcompletionstream.ChatCompletionUserCase, chatConfigStream chatcompletionstream.ChatCompletionConfigDTO, streamChannel chan chatcompletionstream.ChatCompletionOutputDTO) *ChatService {
	return &ChatService{
